...
int main() {
    ...
    for (const std::string filename : {"instances/X/X-n101-k25.vrp",
        ...
        solver = mocvrp::MHACO_Solver(instance);
        ...
        // The solution archive cannot be bigger than the population.
        solver.ker = 16;
