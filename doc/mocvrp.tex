...
%%
%% Self-contained: builds with a single run of
%%     latexmk -pdf mocvrp.tex
%% (or two runs of pdflatex).  No external bibliography database, no
%% shell-escape, no generated input files.
...
\bibitem{Archetti2014}
C.~Archetti, M.~G. Speranza, and D.~Vigo.
\newblock Vehicle routing problems with profits.
\newblock In P.~Toth and D.~Vigo, editors, \emph{Vehicle Routing: Problems,
  Methods, and Applications}, 2nd edition, chapter~10, pages 273--297.
  MOS-SIAM Series on Optimization, SIAM, Philadelphia, 2014.

\bibitem{Arnold2019}
F.~Arnold, M.~Gendreau, and K.~S\"orensen.
\newblock Efficiently solving very large-scale routing problems.
\newblock \emph{Computers \& Operations Research}, 107:32--42, 2019.

\bibitem{DIMACS2021}
12th DIMACS Implementation Challenge: CVRP track.
\newblock Competition rules, December 1st, 2021.
\newblock \url{http://dimacs.rutgers.edu/programs/challenge/vrp/cvrp/}

\bibitem{Ehrgott2005}
M.~Ehrgott.
\newblock \emph{Multicriteria Optimization}.
\newblock Springer, Berlin, 2nd edition, 2005.

\bibitem{GavishGraves1978}
B.~Gavish and S.~C. Graves.
\newblock The travelling salesman problem and related problems.
\newblock Working Paper OR-078-78, Operations Research Center, Massachusetts
  Institute of Technology, 1978.

\bibitem{Jozefowiez2008}
N.~Jozefowiez, F.~Semet, and E.-G. Talbi.
\newblock Multi-objective vehicle routing problems.
\newblock \emph{European Journal of Operational Research}, 189(2):293--309,
  2008.

\bibitem{Matl2018}
P.~Matl, R.~F. Hartl, and T.~Vidal.
\newblock Workload equity in vehicle routing problems: A survey and analysis.
\newblock \emph{Transportation Science}, 52(2):239--260, 2018.
...
\bibitem{Queiroga2026}
E.~Queiroga, R.~Martinelli, A.~Subramanian, E.~Uchoa, and T.~Vidal.
\newblock The XL instances and the CVRPLib best known solution challenge.
\newblock arXiv:2601.11467v2 [math.OC], 2026.

\bibitem{TothVigo2014}
P.~Toth and D.~Vigo, editors.
\newblock \emph{Vehicle Routing: Problems, Methods, and Applications}.
\newblock MOS-SIAM Series on Optimization, SIAM, Philadelphia, 2nd edition,
  2014.
